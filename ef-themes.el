...
;;;; diff-hl
    ...
    `(diff-hl-change ((,c :foreground ,bg-changed-refine :background unspecified)))
    `(diff-hl-delete ((,c :foreground ,bg-removed-refine   :background unspecified)))
    `(diff-hl-insert ((,c :foreground ,bg-added-refine :background unspecified)))
    `(diff-hl-reverted-hunk-highlight ((,c :background ,fg-main :foreground ,bg-main)))
;;;; diff-mode
